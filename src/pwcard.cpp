...
const char *PwCard::to_utf8(symbol_type symbol)
{
    ...
    #undef B1
    #undef ____
    static_assert(sizeof(code_page) == 256 * snippet_size + 1, "code page has invalid size");
    return code_page + snippet_size * symbol;
}

char16_t PwCard::to_utf16(symbol_type symbol)
{
    #define ____ u'\0'
    static constexpr std::array<char16_t, 256> code_page {
