...
char16_t PwCard::to_utf16(symbol_type symbol)
{
    static const std::unordered_map<symbol_type, char16_t> symbol_map {
        ...
        {0x80, u'■'}, {0x81, u'□'}, {0x82, u'▲'}, {0x83, u'△'}, {0x84, u'○'}, {0x85, u'●'}, {0x86, u'★'}, {0x87, u'☂'},
        {0x88, u'☀'}, {0x89, u'☁'}, {0x8A, u'☹'}, {0x8B, u'☺'}, {0x8C, u'♠'}, {0x8D, u'♣'}, {0x8E, u'♥'}, {0x8F, u'♦'},
        {0x90, u'♫'}, {0x91, u'€'}, {0x92, u'¥'}, {0x93, u'£'}, {0x94, u'$'}, {0x95, u'!'}, {0x96, u'?'}, {0x97, u'¡'},
        {0x98, u'¿'}, {0x99, u'⊙'}, {0x9A, u'◐'}, {0x9B, u'◩'}, {0x9C, u'�'},
    };
    auto it = symbol_map.find(symbol);
