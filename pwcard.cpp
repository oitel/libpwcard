...
PwCard PwCard::generate(seed_type seed)
{
    PwCard result;
    ...
    static const std::array<symbol_type, 55> init_symbols = {
...
char16_t PwCard::to_utf16(symbol_type symbol)
{
    static const std::unordered_map<symbol_type, char16_t> symbol_map {
                                    {0x32, u'2'}, {0x33, u'3'}, {0x34, u'4'}, {0x35, u'5'}, {0x36, u'6'}, {0x37, u'7'}, {0x38, u'8'}, {0x39, u'9'},
                      {0x41, u'A'}, {0x42, u'B'}, {0x43, u'C'}, {0x44, u'D'}, {0x45, u'E'}, {0x46, u'F'}, {0x47, u'G'},
